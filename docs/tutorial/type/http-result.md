...
Shivneri provides some helper method which return result of type HttpResult. These are - 
...
```
import { Controller, defaultWorker, HTTP_STATUS_CODE, MIME_TYPE  } from "Shivneri";
...
```
import { Controller, defaultWorker, textResult } from "Shivneri";
