...
```
import { Shield, textResult,  redirectResult } from "Shivneri";
...
```
import { Controller, Shields } from "Shivneri";
...
We have created example for you to understand in depth but we will recommend you to create a demo by yourself. Here is example link - [Authentiction Example](https://github.com/ujjwalguptaofficial/Shivneri/tree/master/example/authentication)
